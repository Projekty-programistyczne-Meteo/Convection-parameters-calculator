...
- [Components](components.md) - page, layout, calculators, converter, and reusable UI components.
...
- [Readme react](readme-react.md) - quick information about frontend project: react + vite + typescript
...
- a contact form integrated with EmailJS and Cloudflare Turnstile that uses `useContactForm` for validation, widget lifecycle, and submit behavior,
- shared hooks and typed utilities that keep repeated calculator and converter behavior consistent.
- Cypress test suites for both E2E and component testing are configured under `app/cpc/tests/cypress`.
