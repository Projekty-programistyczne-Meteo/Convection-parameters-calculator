            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-base leading-8">
                  ...
                  students. My goal is to bridge the gap between complex
                  atmospheric calculations and user-friendly interfaces, making
                  it easier for everyone to understand and analyze convective
                  weather patterns.
                </p>
                <p className="text-base leading-8">
                  I recently worked with open-source projects related to
                  different IT topics, like web development, desktop
                  applications, data science, networking, system engineering and
                  machine learning. I have a strong interest in contributing to
                  projects that combine my software engineering skills with my
                  passion for meteorology, and I'm excited to continue
                  developing tools that help others explore and understand the
              ...
              <div>
                ...
                <p className="text-base leading-8">
                  Template text about Filip Szymanek. This section will be
                  updated with detailed information about his background,
        ...
        <section className="mt-12 space-y-6">
          ...
          <div>
            ...
            <p className="text-base leading-8">
              ...
              particularly convective storms and extreme atmospheric events. The
              organization focuses on providing accurate weather warnings,
            ...
            <p className="text-base leading-8">
              ...
              Severe Weather Database. They provide specialized forecasts,
              technical resources, and educational materials about convective
              weather phenomena, helping to improve public awareness and safety
              regarding severe storms, tornadoes, and other dangerous
